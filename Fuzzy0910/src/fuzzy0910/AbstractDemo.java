...
public abstract class AbstractDemo {
	...
	public void start() {
		...
		while (running) {
			...
			g.drawString("Energy: "+world.getTotalEnergy(),10,190);*/
                        ...
                        g.drawString("Fricción del terreno: "+ mu,10,50);
                        g.drawString("Distancia a meta: "+ dist,10,70);
                        g.drawString("Velocidad en X: "+ velX,10,90);
			g.dispose();
			strategy.show();
	...
	protected void renderGUI(Graphics2D g) {
		g.setColor(Color.black);
		g.drawString("R - Volver a ejecutar la simulación",15,430);
                g.drawString("A - Frenado manual",15,450);
	}
